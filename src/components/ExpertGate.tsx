    ...
    <div className="relative">
      <div className="absolute inset-0 z-50 bg-black/60 backdrop-blur-xl rounded-[60px] flex items-center justify-center p-8 border border-white/5 shadow-2xl">
        <div className="max-w-md text-center space-y-8">
          <div className="w-16 h-16 bg-blue-600 rounded-[24px] flex items-center justify-center mx-auto shadow-2xl shadow-blue-500/20">
          ...
          <Link href="/?plan=expert" className="inline-flex w-full py-5 bg-white text-black rounded-3xl font-[1000] text-lg items-center justify-center gap-3 hover:bg-blue-600 hover:text-white transition-all shadow-xl">
