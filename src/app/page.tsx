...
export default function Home() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      await minimumWait;
      if (!response.ok || !data.success) throw new Error(data.error || "Neural parsing failed.");
  ...
  const handlePaymentSubmit = () => {
    ...
    if (!utrRegex.test(utr)) {
      setPaymentError("Invalid UTR (12-digit number required)");
      return;
    }
    if (!tidRegex.test(transactionId)) {
      setPaymentError("Invalid Transaction ID (PhonePe format required)");
      return;
    }
    setPaymentStep(3);
    setTimeout(() => {
    ...
    <nav className="fixed top-0 w-full z-[100] border-b border-white/5 bg-black/60 backdrop-blur-fix">
      <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 md:h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <span className="text-lg md:text-2xl font-black tracking-tighter">Placement<span className="text-blue-500">Score</span></span>
        </Link>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="lg:hidden absolute top-full left-0 w-full bg-[#0A0A0A] border-b border-white/5 px-6 py-10 space-y-8 flex flex-col items-center text-center shadow-2xl z-[90]">
             ...
             <Link href="/blog" onClick={() => setIsMenuOpen(false)} className="text-2xl font-black italic">Blog</Link>
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "An ATS score represents how effectively recruitment software used by top MNCs can parse and rank your resume. A higher score means better visibility for recruiters."
                }
              },
              {
                "@type": "Question",
                "name": "How accurate is the placement score provided?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Our engine maintains 95%+ parity with industry-standard software like Workday and Taleo by using reverse-engineered recruitment logic."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes. We use volatile memory processing, meaning your resume is analyzed in RAM and purged within 30 minutes. We never store resume text permanently."
                }
              }
            ]
          }),
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} key="landing" className="relative z-10">
              ...
              <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 md:gap-20">
                <div className="flex-1 text-center lg:text-left space-y-6 md:space-y-10">
                  ...
                  <p className="text-lg md:text-xl text-white/40 max-w-2xl lg:mx-0 mx-auto font-medium leading-relaxed text-balance">
                    Recruiters spend only 6 seconds on your resume. If your ATS score is below 80, you're getting rejected instantly. Check Your Resume Score in 30 Seconds.
                  </p>
                  
                  <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-6 justify-center lg:justify-start pt-4">
                    <button onClick={() => scrollToSection('upload')} className="w-full sm:w-auto bg-blue-600 text-white px-8 md:px-12 py-5 md:py-6 rounded-[24px] font-black text-lg md:text-xl hover:bg-blue-500 transition-all shadow-2xl shadow-blue-500/30 flex items-center justify-center gap-3 group">
            ...
            <section className="py-8 md:py-10 border-y border-white/5 bg-white/[0.02]">
               <div className="max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 text-center text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] text-white/30">
                  ...
                  <div className="flex items-center justify-center gap-2 md:gap-3"><Users className="w-4 h-4 text-blue-500" /> Verified MNC Filters</div>
                  <div className="flex items-center justify-center gap-2 md:gap-3"><Star className="w-4 h-4 text-amber-500" /> 4.9/5 Student Rating</div>
               </div>
            </section>

            <section id="upload" className="py-24 md:py-40 px-4 md:px-6 max-w-5xl mx-auto">
                <div className="text-center mb-12 md:mb-16 space-y-4">
                  <h2 className="text-4xl md:text-6xl font-black italic tracking-tighter uppercase leading-tight">See Exactly Where You Stand</h2>
            ...
            <section className="py-24 md:py-40 px-4 md:px-6 bg-indigo-600/[0.02]">
               <div className="max-w-7xl mx-auto">
                  <div className="text-center mb-16 md:mb-32 space-y-4">
                     <h2 className="text-4xl md:text-6xl font-[1000] italic tracking-tighter uppercase leading-tight">Success Stories</h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
                     <TestimonialCard quote="I was getting rejected by every ATS. This tool showed me basic keywords like 'SDLC' were missing. Fixed it, and got shortlisted the next week!" name="Rahul S." role="Software Engineer @ TCS" />
                     <TestimonialCard quote="The ₹199 report saved my placement season. It showed my resume failed readability scans. Highly recommend for every engineering student." name="Priya M." role="Full Stack Dev @ Wipro" />
                     <TestimonialCard quote="Quantifying my achievements as per the suggestions made all the difference. This tool is a must-have for campus drives." name="Ankit V." role="Intern @ Infosys" />
                  </div>
               </div>
            </section>
            ...
            <section id="pricing" className="py-24 md:py-40 px-4 md:px-6 max-w-7xl mx-auto">
               ...
               <div className="mt-20 md:mt-40 overflow-x-auto rounded-[30px] md:rounded-[50px] border border-white/5 bg-white/[0.01] shadow-2xl no-scrollbar backdrop-blur-fix">
            ...
            <section id="faq" className="py-24 md:py-40 px-4 md:px-6 max-w-4xl mx-auto">
               ...
               <div className="space-y-4 md:space-y-6">
                  {[
                     { q: "What is an ATS resume score?", a: "An ATS (Applicant Tracking System) score represents how effectively recruitment software can read and rank your resume for human recruiters." },
                     { q: "How accurate is the placement score?", a: "Our engine uses algorithms reverse-engineered from major systems like Workday and Taleo, maintaining over 95% logic parity." },
                     { q: "Do you store resume content?", a: "No. Resumes are processed in volatile memory and purged immediately after analysis. We prioritize your privacy above all." }
                  ].map((item, i) => (
                ...
                {paymentStep === 1 && (
                   <div className="space-y-10 md:space-y-12">
                      <div className="p-10 md:p-14 bg-white/[0.02] rounded-[30px] md:rounded-[48px] border border-white/10">
                        ...
                        <span className="text-7xl md:text-9xl font-[1000] tracking-tighter italic text-center block leading-none">₹{selectedPlan?.price || 199}</span>
                      </div>
                ...
                {paymentStep === 2 && (
                   <div className="space-y-10 md:space-y-12">
                      ...
                      <div className="text-left space-y-6 md:space-y-8">
                        ...
                        {paymentError && <div className="p-4 bg-red-500/10 border border-red-500/20 text-red-500 text-[10px] font-[1000] rounded-xl uppercase tracking-widest text-center leading-relaxed">{paymentError}</div>}
