    ...
    <main className="min-h-screen bg-[#050505] text-white p-6 pt-32 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10 space-y-12">
        ...
        <div className="text-center lg:text-left space-y-4">
          <h1 className="text-5xl md:text-7xl font-[1000] italic uppercase tracking-tighter leading-tight italic">
                  ...
                  <div className="relative group">
                      ...
                      {!file ? (
                        ...
                        <div className="space-y-10 py-10">
                          ...
                          <button onClick={runAnalysis} className="w-full py-6 bg-white text-black rounded-3xl font-[1000] text-2xl hover:bg-blue-600 hover:text-white transition-all shadow-2xl uppercase italic">SCAN FOR {company}</button>
                        </div>
                      )}
                  </div>
                ...
                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-gradient-to-br from-blue-600 to-indigo-700 p-12 md:p-16 rounded-[70px] shadow-2xl space-y-10 relative overflow-hidden text-center">
                  ...
                  <div className="relative z-10 space-y-8 text-center">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-white/60 font-medium">Your resume has been benchmarked against standard {company} filters.</p>
                      </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="p-6 bg-white/[0.02] rounded-3xl border border-white/5 flex items-start gap-4">
                              ...
                              <p className="text-sm font-bold text-white/60 italic leading-relaxed">Adjust section hierarchy to match {company}'s preferred format.</p>
                            </div>
                            <div className="p-6 bg-white/[0.02] rounded-3xl border border-white/5 flex items-start gap-4">
                              <CheckCircle2 className="text-green-500 w-6 h-6 shrink-0 mt-0.5" />
                              <p className="text-sm font-bold text-white/60 italic leading-relaxed">Increase technical density to clear the {company} NQT threshold.</p>
                            </div>
                        </div>
                      </div>
                  </div>
