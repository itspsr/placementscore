...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white font-sans selection:bg-blue-500/30 overflow-x-hidden">
      {/* Background Blobs for Performance (Safari Fix) */}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 md:h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8 font-bold text-sm text-white/50 uppercase tracking-widest">
            ...
            {session?.user ? (
              ...
              <button onClick={handleGoogleLogin} className="bg-white text-black px-6 py-2.5 rounded-xl font-black hover:bg-blue-600 hover:text-white transition-all flex items-center gap-2">Sign In</button>
            )}
          </div>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} key="landing" className="relative z-10">
              ...
              <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 md:gap-20">
                <div className="flex-1 text-center lg:text-left space-y-8">
                  ...
                  <h1 className="text-4xl sm:text-6xl md:text-[85px] font-[1000] leading-[1] md:leading-[0.85] tracking-tighter uppercase">
                    Bypass The <br /> <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-500 italic">Corporate Bot.</span>
                  </h1>
                  <p className="text-lg md:text-2xl text-white/40 max-w-2xl lg:mx-0 mx-auto font-medium leading-relaxed italic">
                    90% of resumes are rejected by ATS before a human sees them. Secure your interview call with India's #1 Neural Resume Scanner.
                  </p>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-6 py-6 border-y border-white/5">
                     <div className="space-y-1">
                        ...
                        <p className="text-[10px] uppercase font-bold text-white/20">Avg. Score Boost</p>
                     </div>
                     <div className="space-y-1 border-x border-white/5">
                        <p className="text-indigo-500 font-black text-2xl">63%</p>
                        <p className="text-[10px] uppercase font-bold text-white/20">More Interviews</p>
                     </div>
                     <div className="space-y-1 hidden md:block">
                        <p className="text-green-500 font-black text-2xl">Top 2%</p>
                        <p className="text-[10px] uppercase font-bold text-white/20">Resume Performance</p>
                     </div>
                  </div>
            ...
            <section className="py-24 md:py-40 px-4 md:px-6 bg-white/[0.01]">
               <div className="max-w-7xl mx-auto">
                  <div className="text-center mb-24 space-y-4">
                     ...
                     <p className="text-white/20 font-bold uppercase tracking-[0.3em] text-[10px] md:text-xs">Actual improvements from our students</p>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                     ...
                     <CaseStudyCard name="Priya" college="Tier 2 B.Tech" before={55} after={80} result="Deloitte USI" quote="quantified achievements using AI. Interview calls jumped 3x." />
                  </div>
               </div>
            </section>
                  ...
                  <div className="relative bg-[#0A0A0A] p-8 md:p-20 rounded-[40px] md:rounded-[60px] border border-white/10 shadow-2xl text-center backdrop-blur-fix">
                    ...
                    {!file ? (
                      <label htmlFor="hero-up" className="cursor-pointer block">
                        <div className="p-10 md:p-24 border-2 border-dashed border-white/5 rounded-[30px] md:rounded-[40px] hover:border-blue-500/50 transition-all space-y-10 group/label">
                          <Upload className="w-16 h-16 text-white/5 mx-auto group-hover/label:text-blue-500/50 transition-colors" />
                          <h3 className="text-2xl md:text-4xl font-black italic uppercase tracking-tighter">Select Resume File</h3>
                        </div>
                      </label>
                    ) : (
            ...
            <section id="pricing" className="py-24 md:py-40 px-4 md:px-6 max-w-7xl mx-auto">
               <div className="text-center mb-24 space-y-4">
                  ...
                  <p className="text-white/20 font-bold uppercase tracking-[0.3em] text-[10px]">Trusted by students across India</p>
               </div>
                ...
                <div className="flex-1 space-y-12 md:space-y-16">
                   ...
                   <div className="space-y-6 md:space-y-8">
                      <div className={`p-6 md:p-10 bg-green-500/[0.03] rounded-[30px] md:rounded-[40px] border border-green-500/10 transition-all ${!isPaid ? 'blur-xl opacity-30 select-none' : ''}`}>
                        <h4 className="text-lg md:text-xl font-black text-green-400 mb-6 uppercase tracking-widest flex items-center gap-3 italic text-left underline decoration-green-500/20 underline-offset-8"><CheckCircle className="w-4 h-4 md:w-5 md:h-5" /> Strengths</h4>
                      ...
                      {(isPaid && (selectedPlan?.tier === 'ELITE' || selectedPlan?.tier === 'EXPERT')) ? (
                         <div className="p-6 md:p-10 bg-amber-500/[0.03] rounded-[30px] md:rounded-[40px] border border-amber-500/10">
                           <h4 className="text-lg md:text-xl font-black text-amber-400 mb-6 uppercase tracking-widest flex items-center gap-3 italic text-left underline decoration-amber-500/20 underline-offset-8"><Target className="w-4 h-4 md:w-5 md:h-5" /> Skill Gaps</h4>
            ...
            <div className="grid grid-cols-2 gap-10 md:gap-32 text-center md:text-left max-w-lg mx-auto lg:mx-0">
               ...
               <div className="space-y-8 md:space-y-10">
                  ...
                  <div className="space-y-4 md:space-y-6">
                     <p className="text-[10px] md:text-sm font-bold text-white/30 italic uppercase leading-relaxed">Expert team ready 24/7.</p>
