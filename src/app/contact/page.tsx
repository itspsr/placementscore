    ...
    <main className="min-h-screen bg-[#050505] text-white p-6 pt-32">
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-24">
        <div className="space-y-12">
          <h1 className="text-5xl md:text-8xl font-[1000] italic uppercase tracking-tighter leading-none">Global <br /> <span className="text-blue-500">Support.</span></h1>
          <p className="text-xl text-white/40 leading-relaxed italic">Our technical support and career counseling hubs are ready to assist your journey 24/7.</p>
          
          <div className="space-y-10">
            <div className="flex items-center gap-8 group">
              <div className="w-20 h-20 bg-white/5 rounded-3xl border border-white/5 flex items-center justify-center group-hover:border-blue-500 transition-all"><Mail className="text-blue-500 w-10 h-10" /></div>
            ...
            <div className="flex items-center gap-8 group">
              <div className="w-20 h-20 bg-white/5 rounded-3xl border border-white/5 flex items-center justify-center group-hover:border-blue-500 transition-all"><MapPin className="text-blue-500 w-10 h-10" /></div>
              <div><h5 className="text-white font-[1000] italic uppercase text-2xl tracking-tighter">Corporate Office</h5><p className="font-bold text-white/20 text-lg italic">Sector V, Salt Lake, Kolkata, India</p></div>
            </div>
          </div>
        </div>

        <div className="bg-white/5 p-10 md:p-16 rounded-[60px] border border-white/10 space-y-10 shadow-2xl">
